...
if __name__ == '__main__':
  ...
  print("word2idx")
  print(word2idx['propagation'])
  print(word2idx['infection'])
  print(word2idx['athens'])
  print(word2idx['science-fiction'])
  print(word2idx['umbrella'])
  x = input("Any key to continue...")
  print("")
  ...
  print("bigram_probs")
  print(bigram_probs)
  x = input("press c and enter to continue...")
